...
{
	private $api_key = 'VgsKOA7V_cVzHyMSWsAS';
	private $test_api_key = 'VgsKOA7V_cVzHyMSWsAS';
	private $domain = '36stories'; //your chargify domain, e.g. if you have [your-domain].chargify.com, then enter "your-domain" only.
	private $test_domain = '36stories';
