	...
	<div id="mainbodycontent">
		<div id="pricing-page-contents">
            	...
            	<div id="the-plans">
                    ...
                    <div class="plan-box">
                    	<div class="enhanced">
                            ...
                            <div class="signup-blue" onclick="window.location='registration/enhanced'"></div>
                        </div>
                    </div>
                    <div class="plan-box">
                    	<h1>Premium</h1>
            ...
            <div class="page-block" style="padding-right:10px;">
                ...
                <p>Yep. Simply click on the "Account" tab on your dashboard and you'll see your options.</p>
            </div>
            ...
            <div class="info-block mag">
                ...
                <p>Here are our Terms of Service and our Privacy Policy.</p>
            </div>
        </div>
    </div>
</div>
